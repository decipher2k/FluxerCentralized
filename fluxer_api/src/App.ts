...
import {SsoSessionMiddleware} from '~/sso/SsoSessionMiddleware';
import {initializeSsoClient} from '~/sso/SsoClientSingleton';
...
routes.use(SsoSessionMiddleware);
